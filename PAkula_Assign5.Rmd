...
output <- sumCoordinates(bc[,1], bc[,2])

plot(x=bc[!output,1], y=bc[!output,2], xlab="x", ylab="y", col='blue', pch=20, xlim=c(0,1), ylim=c(0,1), asp=1)
points(bc[output,1], bc[output,2], col='green', pch=20)
```
...
#get true if sum of the coordinates is less than 0.5
output <- prodCoordinates(bc[,1], bc[,2])
...
#get true if sum of the coordinates is less than 0.5
output <- diffCoordinates(bc[,1], bc[,2])
...
#get true if sum of the coordinates is less than 0.5
for (i in 1:n){
  output[i] <- maxCoordinates(bc[i,1], bc[i,2])
}
...
#get true if sum of the coordinates is less than 0.5
for (i in 1:n){
  output[i] <- minCoordinates(bc[i,1], bc[i,2])
}
